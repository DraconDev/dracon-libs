...
mod tests {
    ...
    #[test]
    fn test_probability_exac[DRACON_SECRET:]() {
        let mut sm = VadStateMachine::new();
    ...
    #[test]
    fn test_exac[DRACON_SECRET:]() {
        let mut sm = VadStateMachine::new();
        sm.process(0.6);
        sm.process(0.6);
        assert_eq!(sm.state, VadState::SpeechDetected);
