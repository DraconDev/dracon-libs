...
impl ExampleMeta {
    fn all() -> Vec<Self> {
        vec![
            ExampleMeta { name: "widget_gallery", category: "cookbook", description: "All interactive widgets in one App", _widgets: "Checkbox, Radio, Slider...", run_cmd: "cargo run --example widget_gallery" },
            ExampleMeta { name: "tree_navigator", category: "cookbook", description: "Hierarchical navigation with Tree", _widgets: "Tree, Breadcrumbs, SplitPane", run_cmd: "cargo run --example tree_navigator" },
            ExampleMeta { name: "log_monitor", category: "cookbook", description: "Real-time log viewer with filtering", _widgets: "LogViewer, StatusBadge", run_cmd: "cargo run --example log_monitor" },
            ExampleMeta { name: "tabbed_panels", category: "cookbook", description: "Tab switching with per-tab state", _widgets: "Tabbar, Gauge, List, Select", run_cmd: "cargo run --example tabbed_panels" },
            ExampleMeta { name: "data_table", category: "cookbook", description: "Sortable table with search/filter", _widgets: "SearchInput", run_cmd: "cargo run --example data_table" },
            ExampleMeta { name: "split_resizer", category: "cookbook", description: "Nested SplitPane with drag-to-resize", _widgets: "SplitPane (nested)", run_cmd: "cargo run --example split_resizer" },
            ExampleMeta { name: "command_bindings", category: "cookbook", description: "5 command-bound widgets with auto-refresh", _widgets: "Gauge, KeyValueGrid, StatusBadge...", run_cmd: "cargo run --example command_bindings" },
            ExampleMeta { name: "menu_system", category: "cookbook", description: "MenuBar + ContextMenu with shortcuts", _widgets: "MenuBar, ContextMenu, List, Toast", run_cmd: "cargo run --example menu_system" },
            ExampleMeta { name: "debug_overlay", category: "cookbook", description: "Debug tools overlay with F12 toggle", _widgets: "DebugOverlay, Profiler, EventLogger", run_cmd: "cargo run --example debug_overlay" },
            ExampleMeta { name: "system_monitor", category: "apps", description: "htop-like dashboard with live gauges", _widgets: "Gaugex4, KeyValueGrid, StreamingText", run_cmd: "cargo run --example system_monitor" },
            ExampleMeta { name: "file_manager", category: "apps", description: "Full file manager UI with Tree + Table", _widgets: "Tree, Table, Breadcrumbs, ContextMenu", run_cmd: "cargo run --example file_manager" },
            ExampleMeta { name: "chat_client", category: "apps", description: "Rich chat UI with emoji picker", _widgets: "List, TextInput, Toast, Modal", run_cmd: "cargo run --example chat_client" },
            ExampleMeta { name: "dashboard_builder", category: "apps", description: "All command widgets in grid layout", _widgets: "Gauge, KeyValueGrid, StatusBadge...", run_cmd: "cargo run --example dashboard_builder" },
            ExampleMeta { name: "form_demo", category: "existing", description: "Settings form with validation", _widgets: "SearchInput, PasswordInput, Select...", run_cmd: "cargo run --example form_demo" },
            ExampleMeta { name: "theme_switcher", category: "existing", description: "Live theme cycling through all 15 themes", _widgets: "StatusBadge, Gauge, List", run_cmd: "cargo run --example theme_switcher" },
            ExampleMeta { name: "modal_demo", category: "existing", description: "ConfirmDialog + help overlay", _widgets: "Modal, ConfirmDialog, Button", run_cmd: "cargo run --example modal_demo" },
            ExampleMeta { name: "widget_tutorial", category: "existing", description: "Build a custom ColorPicker widget", _widgets: "Custom (ColorPicker)", run_cmd: "cargo run --example widget_tutorial" },
            ExampleMeta { name: "command_dashboard", category: "existing", description: "Auto-refresh dashboard", _widgets: "Gauge, KeyValueGrid, StatusBadge", run_cmd: "cargo run --example command_dashboard" },
            ExampleMeta { name: "framework_demo", category: "existing", description: "App + List + Breadcrumbs + SplitPane", _widgets: "List, Breadcrumbs, SplitPane, Hud", run_cmd: "cargo run --example framework_demo" },
            ExampleMeta { name: "framework_chat", category: "existing", description: "Simple chat interface", _widgets: "List, Input", run_cmd: "cargo run --example framework_chat" },
            ExampleMeta { name: "framework_file_manager", category: "existing", description: "File browser", _widgets: "List, Breadcrumbs, ContextMenu", run_cmd: "cargo run --example framework_file_manager" },
            ExampleMeta { name: "framework_widgets", category: "existing", description: "Instantiate all widgets and print debug", _widgets: "Checkbox, Radio, Slider...", run_cmd: "cargo run --example framework_widgets" },
            ExampleMeta { name: "cyberpunk_dashboard", category: "existing", description: "Cyberpunk-themed dashboard", _widgets: "SplitPane, List, Hud", run_cmd: "cargo run --example cyberpunk_dashboard" },
        ]
    }
}
