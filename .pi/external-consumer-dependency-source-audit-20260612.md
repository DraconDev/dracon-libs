...
| `dracon-utilities` remote sync | `git push codeberg HEAD:main` and `git push gitlab HEAD:main` | Pass; both now point at `4c51b95bc20810047925f321d3df2d5a59cd6543`. |
| `dracon-utilities` GitHub remote sync | `git push github HEAD:main` | Blocked: rejected as non-fast-forward because GitHub main is `9ca1a5804ee7091d3d7fd1f4a00569cb7c0323e6`; requires either pulling/integrating remote changes or explicit `--force-with-lease` approval. |
