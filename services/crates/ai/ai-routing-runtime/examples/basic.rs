...
use ai_routing_runtime::{
    ProviderRegistry, RoutingMessage, RoutingTask, SelectionConstraints,
    ServiceLevel, SmartRouter,
};
...
async fn main() {
    ...
    println!("RoutingTask lanes: General={:?}, Code={:?}, Research={:?}, Creative={:?}",
        RoutingTask::General, RoutingTask::Code, RoutingTask::Research, RoutingTask::Creative);
